...
namespace MercenariesAndBeasts.Web.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        {
            // uvnitř ExternalLoginModel.OnGetCallbackAsync(...)
            ...
            // když to není spárované, zkusíme najít usera podle emailu
            ...
            if (!string.IsNullOrWhiteSpace(email))
            {
                ...
                if (user != null)
                {
                    // volitelně: ověř, že provider poslal ověřený email (Google umí "email_verified")
            ...
            // fallback: standardní flow = nabídni vytvoření účtu
