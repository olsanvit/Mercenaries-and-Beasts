...
namespace MercenariesAndBeasts.Infrastructure.Migrations
{
    ...
    [Migration("20260103134131_AddGen2613")]
    partial class AddGen2613
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MercenariesAndBeasts.Domain.BeastEquipmentSlot", b =>
                {
                    b.HasOne("MercenariesAndBeasts.Domain.Units.PlayerMonster", null)
                        .WithMany("Equipment")
            ...
            modelBuilder.Entity("MercenariesAndBeasts.Domain.Items.ItemTemplate", b =>
                {
                    b.HasOne("MercenariesAndBeasts.Domain.Units.MercenaryTemplate", "GrantedMercenaryTemplate")
                        .WithMany()
                        .HasForeignKey("GrantedMercenaryTemplateId");

                    b.HasOne("MercenariesAndBeasts.Domain.Units.MonsterTemplate", "GrantedMonsterTemplate")
                        .WithMany()
                        .HasForeignKey("GrantedMonsterTemplateId");

                    b.HasOne("MercenariesAndBeasts.Domain.Units.MercenaryTemplate", "MercenaryTemplate")
                        .WithMany()
                    ...
                    b.OwnsOne("MercenariesAndBeasts.Domain.Combat.StatBlock", "BaseStats", b1 =>
                        {
                            ...
                            b1.Property<double>("ActionCostReduction")
                                .HasColumnType("double precision");
                            ...
                            b1.Property<double>("CooldownReduction")
                                .HasColumnType("double precision");
            ...
            modelBuilder.Entity("MercenariesAndBeasts.Domain.MercenaryEquipmentSlot", b =>
                {
                    b.HasOne("MercenariesAndBeasts.Domain.Units.PlayerMercenary", null)
                        .WithMany("Equipment")
            ...
            modelBuilder.Entity("MercenariesAndBeasts.Domain.Players.PlayerBeastSlot", b =>
                {
                    b.HasOne("MercenariesAndBeasts.Domain.Units.PlayerMonster", "Beast")
                        .WithMany()
            ...
            modelBuilder.Entity("MercenariesAndBeasts.Domain.Players.PlayerMercenarySlot", b =>
                {
                    b.HasOne("MercenariesAndBeasts.Domain.Units.PlayerMercenary", "Mercenary")
                        .WithMany()
